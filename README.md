# Run Mocha Tests With Browser Extensions on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Mocha Tests With Browser Extensions across real browsers and operating systems.
